  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">search rent</a>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="index.php?page=rent">Rent</a>
          <a class="dropdown-item" href="index.php?page=AddCar">Add car</a>
        </div>
      </li>
